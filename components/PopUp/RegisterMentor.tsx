import { Box, Button, Flex, FormLabel, Heading, Modal, ModalBody, ModalCloseButton, ModalContent, useColorModeValue, ModalFooter, ModalOverlay, Stack, Text, Textarea, useDisclosure } from '@chakra-ui/react';
...
const RegisterMentor: React.FC<ApplyForMentorProps> = () => {
    ...
    return (
        <>
            ...
            onClick={onOpen}>Request for Mentorship</Button>
